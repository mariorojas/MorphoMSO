 ...
 *
 * Clase para gestionar la interfaz de captura de huellas digitales
 */
public class INEFingerVerificationFragment extends ParentFragment implements View.OnClickListener, MSOShower {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View layoutView = inflater.inflate(R.layout.ine_finger_verification_fragment_layout, container,
                false);
        root = layoutView;
    ...
    /**
     * Inicialización de componentes en vista
     * @param root
     */
    ...
    /**
     * Inicialización para indicadores de huellas en vista
     * @param root
     */
    ...
    /**
     * Reinicialización de captura de huellas
     * @param deleteImageFingerPosition
     */
    ...
    /**
     * Gestión de indicador de huellas en vista
     * @param v
     */
    @Override
    ...
    /**
     * Actualización de indicador de huella en vista
     * @param imgeSrc
     * @param captureError
     */
    ...
    /**
     * Habilitar botón de enrolamiento
     */
    ...
    private class EnrollListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ResetCapture(true);
            showAlert("Alerta", "Si terminas la captura ya no se permitirá modificar o agregar huellas. ¿Deseas continuar?", "Continuar", "Cancelar", new DialogUses() {
                @Override
    ...
    /**
     * Asignación de huellas capturadas en Base64 hacia buffers
     */
