 ...
 */
public class FingerprintAuthFragment extends ParentFragment implements View.OnClickListener, MSOShower {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View layoutView = inflater.inflate(R.layout.finger_auth_layout, container,
                false);
        ...
        try {
            MSOConnection.getInstance().getUSBPermission( getActivity());
    ...
    private class EnrollListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            ResetCapture(true);
            showAlert("Alerta", "Si terminas la captura ya no se permite modificar o agregar huellas. ¿Deseas continuar?"
